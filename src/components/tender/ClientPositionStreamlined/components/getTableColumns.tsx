// This file exports the EXACT column definitions from the original file
// No changes to structure, just extracted as a function
...
// This function returns EXACTLY the same columns as in the original file
// We're just wrapping them in a function to extract from the main component
export const getTableColumns = (params: GetTableColumnsParams): ColumnsType<BOQItemWithLibrary> => {
  const { position, handleEditWork, handleEditMaterial, handleDeleteItem } = params;
