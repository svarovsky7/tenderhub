...
/**
 * Хук для сортировки элементов BOQ с учетом связей работ и материалов
 *
 * Логика сортировки:
 * 1. Сначала идут работы и суб-работы (отсортированные по sub_number)
...
export const useSortedBOQItems = ({
  ...
  return useMemo(() => {
    ...
    if (position.is_additional) {
      console.log('✅ ДОП sorted items in useSortedBOQItems:', {
        work_name: position.work_name,
