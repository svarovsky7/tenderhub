-- Migration: Add functions for material drag & drop between works
-- Description: Enables moving/copying materials between works with automatic recalculation
...
-- Add comments
COMMENT ON FUNCTION public.rpc_move_material IS 'Moves or copies a material link between works with automatic recalculation';
